        ...
        <div className="px-4 py-5 my-5 text-center">
          ...
          <div className="col-lg-6 mx-auto">
            <p className="lead mb-4 font-bookantiqua">
              ...
              de Marcel Proust. Laissez vous inspirer et rajouter vos propres
        ...
        <div>
          ...
          <div className="row align-items-center g-lg-5 py-5 px-10">
            ...
            <div className="col-lg-6 mx-auto fs-4 px-5 font-bookantiqua">
              <p>
                Bienvenue sur le site des citations ultimes flamboyantes
                inspirées de Marcel Proust. Laissez vous inspirer et rajouter
                vos propres citations. Si vous manquez d'idées vous pouvez aller
                consulter les citations des autres utilisateurs. Pour une
                meilleure utilisation vous pouvez vous connecter grâce à votre
                compte discord.
              </p>
