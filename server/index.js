...
const HTML_FILE = path.join(process.env.ENVIRONMENT == "dev" ? PUBLIC_DIR : DIST_DIR, "index.html");
...
app.get('/api/get-user/:username', function(req, res){ //donne un utilisateur
